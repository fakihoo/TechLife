...
namespace TechLife.Migrations
{
    ...
    [Migration("20240830112907_editservicetodb")]
    partial class editservicetodb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechLife.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TechLife.Models.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TechLife.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TechLife.Models.ProductLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TechLife.Models.ProductView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TechLife.Models.Service", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ServiceId = 1,
                            CreatedAt = new DateTime(2024, 8, 30, 14, 29, 5, 479, DateTimeKind.Local).AddTicks(2519),
            ...
            modelBuilder.Entity("TechLife.Models.Image", b =>
                {
                    b.HasOne("TechLife.Models.Product", "Product")
                        .WithMany("Images")
